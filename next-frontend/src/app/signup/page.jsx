            ...
            <div>
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <span className="text-sm flex-1" style={{ color: 'var(--text-secondary)' }}>
                  I agree to the{' '}
                  <Link href="/terms" className="font-medium hover:opacity-80 transition" style={{ color: 'var(--accent-green)' }}>
                    Terms of Service
                  </Link>
                  {' '}and{' '}
                  <Link href="/privacy" className="font-medium hover:opacity-80 transition" style={{ color: 'var(--accent-green)' }}>
                    Privacy Policy
                  </Link>
                </span>
              </label>
