...
import { 
  Calendar, MapPin, Users, Clock, Tag, Filter, 
  Search, X, CalendarDays, List,
...
const EventsPage = () => {
    ...
    return eventsData.map(event => {
      ...
      const parseEventDate = (dateString) => {
        ...
        try {
          ...
          // Handle invalid dates or dates before today (October 2, 2025)
      ...
      const today = new Date('2025-10-02'); // Set today's date as October 2, 2025
      ...
      return {
        ...
        eventid: event.eventid, // Include eventid for direct links
        time: (() => {
        ...
        imageUrl: event.images?.[0]?.url || `https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=400&fit=crop&crop=center`,
  ...
  React.useEffect(() => {
    if (events.length > 0) {
      console.log('Processed Events with Dates:', events.slice(0, 5).map(e => ({
        title: e.title,
        date: e.date,
        parkName: e.parkName
      })));
  ...
  const filteredEvents = useMemo(() => {
    return events.filter(event => {
      ...
      if (filters.dateRange === 'upcoming') {
        ...
        return eventDate.getMonth() === 9 && eventDate.getFullYear() === 2025; // October 2025
      } else if (filters.dateRange === 'next-month') {
        return eventDate.getMonth() === 10 && eventDate.getFullYear() === 2025; // November 2025
      }
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              { label: 'This Month', value: eventsByMonth[`2025-9`]?.length || 0, icon: TrendingUp }, // October 2025 (month index 9)
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="sm:hidden flex items-center gap-2 px-4 py-2.5 rounded-xl font-medium transition"
                style={{
                  backgroundColor: 'var(--surface)',
                  borderWidth: '1px',
                  borderColor: 'var(--border)',
              ...
              <select
                ...
                className="px-4 py-2.5 rounded-xl text-sm font-medium outline-none cursor-pointer transition"
                style={{
                  backgroundColor: 'var(--surface)',
                  borderWidth: '1px',
                  borderColor: 'var(--border)',
              ...
              {activeFiltersCount > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 rounded-full text-sm hover:bg-white/5 transition"
                  style={{
                    backgroundColor: 'var(--surface)',
                    borderWidth: '1px',
                    borderColor: 'var(--border)',
            ...
            >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${
                  viewMode === 'calendar' ? 'bg-white/10' : 'hover:bg-white/5'
                }`}
                style={{ color: 'var(--text-primary)' }}
              >
              ...
              {error && (
                <div className="text-center py-24">
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded-full bg-purple-500 hover:bg-purple-600 text-white font-semibold transition"
                  >
                    Retry
                  </button>
                </div>
                  ...
                  {totalPages > 1 && (
                    <div className="flex items-center justify-center gap-2 mt-8">
                      <button
                        ...
                        style={{
                          backgroundColor: currentPage === 1 ? 'var(--surface)' : 'var(--bg-secondary)',
                          borderWidth: '1px',
                          borderColor: 'var(--border)',
                          color: 'var(--text-primary)'
                        }}
                          ...
                          return (
                            <button
                              ...
                              className={`px-3 py-2 rounded-lg font-medium transition ${
                                currentPage === pageNum ? 'bg-purple-500 text-white' : ''
                              }`}
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-lg font-medium transition disabled:opacity-50 disabled:cursor-not-allowed"
                        style={{
                          backgroundColor: currentPage === totalPages ? 'var(--surface)' : 'var(--bg-secondary)',
                          borderWidth: '1px',
                          borderColor: 'var(--border)',
                          color: 'var(--text-primary)'
                        }}
        ...
        <div className="fixed inset-0 z-50 sm:hidden">
          ...
          >
            ...
            <div className="mt-8 flex gap-3">
              ...
              <button
                onClick={() => setShowFilters(false)}
                className="flex-1 py-3 rounded-xl bg-purple-500 hover:bg-purple-600 text-white font-semibold transition"
              >
                Apply
              </button>
            </div>
