...
import { 
  Compass, Mountain, Sparkles, Clock, Wallet, Shield, 
  MapPin, Calendar, Heart, Camera, BookOpen, Route,
  ChevronDown, Mail, Lock, Star, Play
} from 'lucide-react';
...
const LandingPage = () => {
  ...
  const organizationSchema = {
    ...
    contactPoint: {
      ...
      email: 'travelswithkrishna@gmail.com'
    }
  };
    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-32 lg:pt-40 pb-32 lg:pb-48 text-center">
          {/* Badge */}
          <div 
            className="inline-flex items-center gap-2 rounded-full px-4 py-2 ring-1 backdrop-blur mb-8"
            style={{
              backgroundColor: 'var(--surface)',
              borderColor: 'var(--border)'
            }}
          >
            <Route className="h-4 w-4" style={{ color: 'var(--text-primary)' }} />
          ...
          {/* Main Headline */}
          <h1 
            className="text-5xl sm:text-6xl lg:text-8xl font-light tracking-tighter leading-none mb-6"
          ...
          {/* Subheadline */}
          <p 
            className="mx-auto mt-6 max-w-4xl text-lg sm:text-xl leading-relaxed"
            style={{ color: 'var(--text-primary)' }}
          >
          ...
          >
            ...
            <span className="uppercase tracking-wider">Secure & Private</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                ...
                description: 'Weather, crowds, and conditions'
              },
              {
                icon: Wallet,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
              {[
                ...
                },
                {
                  ...
                  icon: Camera,
                  description: 'Navigate with real-time updates, weather info, and adaptive routing.',
                  badges: [
                    { label: 'Real-time updates', color: 'bg-green-400' },
                    { label: 'Adaptive routing', color: 'bg-blue-400' },
          ...
          >
            ...
            {isAuthenticated ? (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full bg-forest-500 hover:bg-forest-600 text-white px-8 py-4 text-base font-semibold transition shadow-lg hover:shadow-forest-500/50"
              >
